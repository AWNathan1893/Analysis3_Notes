...
\begin{Def}{Content Zero Sets}{content:zero}\index{Content Zero}
...
\section{Two Elementary Regions}\index{Elementary Region}
...
\begin{figure}[H]
  \centering
  \def\svgwidth{2.3in}
  \subimport{../figures/ysimpleRegion}{ysimpleRegion.pdf_tex}
...
\begin{Eg}{Examples of elementary regions}{}
  ...
  \begin{figure}[H]
    \centering
    \def\svgwidth{2.6in}
    \subimport{../figures/simpleRegion}{simpleRegion.pdf_tex}
