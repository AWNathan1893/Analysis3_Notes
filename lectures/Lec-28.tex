...
\begin{Thm}{$\R^2$ version of Green's Theorem}{gtm}\index{Green's Theorem}
...
\begin{Thm}{Gauss Divergence Theorem}{gdt}\index{Gauss Divergence Theorem}
...
\section{Stokes' Theorem}\index{Stokes' Theorem}
